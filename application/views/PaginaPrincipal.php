...
<link href="./template/css/menu.css" rel="stylesheet" type="text/css" media="all" /> <!-- menu style -->
<link href="./template/css/ken-burns.css" rel="stylesheet" type="text/css" media="all" /> <!-- banner slider -->
<link href="./template/css/animate.min.css" rel="stylesheet" type="text/css" media="all" />
<link href="./template/css/owl.carousel.css" rel="stylesheet" type="text/css" media="all"> <!-- carousel slider -->
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
...
<script src="j./template/s/jquery-scrolltofixed-min.js" type="text/javascript"></script>
<script>
    $(document).ready(function() {
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub">
					...
					<select class="form-control bfh-states" data-country="US" data-state="CA">
						...
						<option value="MS">Mississippi</option><option value="MO">Missouri</option><option value="MEX">Mexico</option><option value="NE">Nebraska</option><option value="NV">Nevada</option><option value="NH">New Hampshire</option><option value="NJ">New Jersey</option>
					</select>
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one-->
			<div class="w3ls-header-left">
				<p><a href="#">Bienvenido a myBook </a></p>
			</div>
				...
				<ul>
					<li class="dropdown head-dpdn">
						...
						<ul class="dropdown-menu">
							<li><a href="login.html">Ver Cuenta</a></li>
							<li><a href="login.html">Mi carrito de compras</a></li>
						</ul>
					</li>
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-percent" aria-hidden="true"></i>Ofertas del dia<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="offers.html">Descuentos</a></li>
							<li><a href="offers.html">Ofertas Especiales</a></li>
						</ul>
					</li>
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-gift" aria-hidden="true"></i> Tarjeta de Regalo<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="offers.html">Registrar tarjeta de regalo</a></li>
							<li><a href="offers.html">Ver saldo</a></li>
						</ul>
					</li>
					<li class="dropdown head-dpdn">
			...
			<div class="clearfix"> </div>xs
		</div>
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<img src="./template/images/logoSmall.png" alt="" class="img-responsive"/>
				</div>
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> Nuevos libros cada semana <span>Encuentra todos los libros que buscas</span> <span>Envio gratuito!</span></a></div>
		...
		<div id="kb" class="carousel kb_elastic animate_text kb_wrapper" data-ride="carousel" data-interval="6000" data-pause="hover">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active"><!-- First-Slide -->
                    <img src="./template/images/carousel1.jpg" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated flipInX">Productos con <span>50%</span> descuento!</h3>
                        <h4 data-animation="animated flipInX">Ofertas por tiempo limitado</h4>
                    </div>
                </div>
                <div class="item"> <!-- Second-Slide -->
                    <img src="./template/images/carousel2.jpg" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated fadeInDown">Editoriales nuevas!</h3>
                        <h4 data-animation="animated fadeInUp">Nuevos productos</h4>
                    </div>
                </div>
                <div class="item"><!-- Third-Slide -->
                    <img src="./template/images/carousel3.jpg" alt="" class="img-responsive"/>
                    <div class="carousel-caption kb_caption kb_caption_center">
                        <h3 data-animation="animated fadeInLeft">Venta de fin de temporada</h3>
                        <h4 data-animation="animated flipInX">Grandes descuentos</h4>
                    </div>
                </div>
            </div>
            <!-- Left-Button -->
		...
		<div class="container">
			<div class="welcome-info">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<div class="clearfix"> </div>
					<h3 class="w3ls-title">Mas vendidos</h3>
								...
								<div id="owl-demo" class="owl-carousel">
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<a href="products.html"><img src="./template/images/masVendidos1.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">Swing Time</a></h4>
												<p>Sadie Smith</p>
												<h5>$100</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="w3ls_item" value="Swing Time" />
													<input type="hidden" name="amount" value="100.00" />
													<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i>Comprar</button>
												</form>
											</div>
										</div>
									</div>
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a href="products.html"><img src="./template/images/masVendidos2.png" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">The Underground Railroad : A Novel</a></h4>
												<p>Colson Whitehead</p>
												<h5>$300</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="w3ls_item" value="The Underground Railroad" />
													<input type="hidden" name="amount" value="300.00"/>
													<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i> Compara</button>
												</form>
											</div>
										</div>
									</div>
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a href="products.html"><img src="./template/images/masVendidos3.jpg" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">Hillbilly Elegy</a></h4>
												<p>J. D. Vance</p>
												<h5>$70</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="w3ls_item" value="Hillbilly Elegy" />
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<a href="products.html"><img src="./template/images/masVendidos4.jpg" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">Before the Fall</a></h4>
												<p>Noah Hawley</p>
												<h5>$80</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="w3ls_item" value="Before the Fall"/>
													<input type="hidden" name="amount" value="80.00"/>
													<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i>Comparar</button>
												</form>
											</div>
										</div>
									</div>
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<a href="products.html"><img src="./template/images/masVendidos5.jpg" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">Small Great Things: A Novel </a></h4>
												<p>Jodi Picoult</p>
												<h5>$100</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<div class="new-tag"><h6>Sale</h6></div>
											<a href="products.html"><img src="./template/images/masVendidos6.jpg" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">The Gene: An Intimate History</a></h4>
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<div class="new-tag"><h6>New</h6></div>
											<a href="products.html"><img src="./template/images/masVendidos7.jpg" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">The Trespasser: A Novel</a></h4>
												<p>Tana French</p>
												<h5>$70</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<a href="products.html"><img src="./template/images/masVendidos8.jpg" alt="img"></a>
											<div class="view-caption agileits-w3layouts">
												<h4><a href="products.html">Pumpkinflowers: A Soldier's Story</a></h4>
												<p>Matti Friedman</p>
												<h5>$80</h5>
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart" />
			...
			<div class="footer-info w3-agileits-info">
				<div class="col-md-4 address-left agileinfo">
					<div class="footer-logo header-logo">
						<h2><img src="./template/images/logoSmall.png" alt="" class="img-responsive"/></h2>
